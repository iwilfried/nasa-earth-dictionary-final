Map<String, String> abbreviations = <String, String>{
  "A/B Test":
      "Testmethode, um die Reaktionen von Testpersonen auf zwei oder mehrere unterschiedliche Varianten (z. B. eines Produkts, einer Webseite, eines E-Mailings oder auch einer Grafik) zu ermitteln\nBundesinstitut für Berufsbildung (BIBB)",
  "Absprungrate":
      "Prozentsatz von Besuchern einer Website, die den nächsten logischen  Schritt  im  Verkaufsprozess  nicht  gehen  und  den  Online-Vertriebskanal verlassen\nBundesinstitut für Berufsbildung (BIBB)",
  "Advertorial":
      "Werbeanzeige in redaktioneller Aufmachung\nBundesinstitut für Berufsbildung (BIBB)",
  "Affiliate-Marketing":
      "Ein Bereich des Online-Marketings, bei dem Webseitenbetrei-ber Werbelinks von Dritten auf ihrer Plattform platzieren",
  "ASP": "sieheAverage Selling Price",
  "Attribut":
      "Attribute sind strukturierte Produkteigenschaften: Sie sind beim  Produkt  vermerkt.  Dies  können  z.  B.  Farbe,  Material,  Größenangaben, Preis oder weitere beschreibende Elemente sein, die vom Kunden zur Eingrenzung der angebotenen Arti-kel genutzt werden können.",
  "Attributierung":
